...
export class DiskFs {
   ...
   * next event arrives. The host never accumulates a duplicate copy of
   * the rendered output bundle; see `spackle.generate`'s docs for the
   * Tera-render-buffer caveat that still applies in core.
   *
